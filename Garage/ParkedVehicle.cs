...
namespace Garage
{
    ...
    {
        public void AlreadyParkedVehicle()
        {
            ...
            parkedVehicles.Add(mountainBike);
            parkedVehicles.Add(racerBike);
            parkedVehicles.Add(vesslaMotorcycle);
            parkedVehicles.Add(yamahaMotorcycle);
